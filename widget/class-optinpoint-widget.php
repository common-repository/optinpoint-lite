 ...
 */
class OptinPoint_Lite_Assistant_Widget extends WP_Widget{
    /**
     * @since    1.0.0
     *
     * @var      string
     */
    protected $widget_slug = 'optinpoint-wp-assistant-widget';
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Quickly add your OptinPoint Widget.'
			)
		);
