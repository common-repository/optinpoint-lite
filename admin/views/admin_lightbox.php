<div id="lightbox" class="optpoint_box">
	<div class="optpoint_item">
		...
		<div class="optpoint_group optpoint_dropc">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(0,data.lite_form)" ng-show="data.lite_form">Edit Form</button>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Theme</label>
			<div class="optpoint_drop">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(1,data.lite_theme||-1)" ng-show="data.lite_theme">Edit Theme</button>
		</div>
	</div>
	<div class="optpoint_item">
		<div class="itemhead">
