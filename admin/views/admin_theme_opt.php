	...
	<div class="optpoint_item">
		<div class="itemhead">
			...
			<span class="optpoint_hint headhint" data-hint="Preview your theme here"></span>
		</div>
		<div class="optpoint_group">
			<button class="optpoint_button orange material-design" ng-click="prev.switch()">{{prev.st?'Close Editor':'Live Editor'}}</button>
		</div>
	</div>
	<div class="optpoint_prev" ng-class="{showlive:prev.st}">
		<div class="optpoint_topbar">
			<div class="optpoint_round" style="background:#f67a00"></div><div class="optpoint_round" style="background:#ebc71f"></div><div class="optpoint_round" style="background:#31bb37"></div><div class="optpoint_left"></div><div class="optpoint_right"></div>
			<div class="optpoint_long">OptinPoint - {{gettpl(theme.tpl).n}} - Live Editor</div>
			<div class="optpoint_search"></div><div class="optpoint_opts"></div>
		</div>
		<div class="optpoint_toptab">
			<div class="optpoint_tab" ng-click="prev.ty = 0" ng-class="{optpoint_tabact:prev.ty == 0}">Lightbox</div>
			<div class="optpoint_tab" ng-click="prev.ty = 1" ng-class="{optpoint_tabact:prev.ty == 1}">Slider</div>
			<div class="optpoint_tab" ng-click="prev.ty = 2" ng-class="{optpoint_tabact:prev.ty == 2}">Widget</div>
			<div class="optpoint_tab" ng-click="prev.ty = 3" ng-class="{optpoint_tabact:prev.ty == 3}">Addon</div>
			
		</div>
		<div class="optpoint_viewportbck">
			<div class="optpoint_lineimg"></div>
			<div class="optpoint_divide" style="left:33%"></div>
			<div class="optpoint_divide" style="left:66%"></div>
			<div ng-repeat="i in fontsiz.slice(0, 2)" class="optpoint_linecont">
				<div ng-repeat="i in fontsiz.slice(0, 10)" class="optpoint_line"></div>
			</div>
		</div>
		<div ng-if="prev.st" class="optpoint_viewport" ng-include="prev.get()"></div>
	</div>
	<div class="optpoint_item" data-setno="1">
		<div class="itemhead">
		...
		<div class="optpoint_group">
			<div class="optpoint_para">Message
				<span class="optpoint_hint" data-hint="Sub-heading"></span>
			</div>
	...
	<div class="optpoint_item" data-setno="2">
		<div class="itemhead">
	...
	<div class="optpoint_item" data-setno="3">
		<div class="itemhead">
		...
		<optcolor ng-model="theme.check_ic" optlab="Selected option Color"></optcolor>
	...
	<div class="optpoint_item" data-setno="4">
		<div class="itemhead">
	...
	<div class="optpoint_item" data-setno="5">
		<div class="itemhead">
				<h2>Personalize your Spinner</h2>
		</div>
		<optcolor ng-model="theme.spinner_c" optlab="Theme Color"></optcolor>
	</div>
	<div class="optpoint_item" data-setno="6">
		<div class="itemhead">
			<h2>Personalize your Status Message</h2>
			<span class="optpoint_hint headhint" data-hint="Customize your Success or Error Message"></span>
		</div>
		<optfont ng-model="theme.status_f"></optfont>
		<optcolor ng-model="theme.status_fc" optlab="Font Color"></optcolor>
	</div>
	<div class="optpoint_item" data-setno="7">
		<div class="itemhead">
				<h2>Personalize your Tag</h2>
				<span class="optpoint_hint headhint" data-hint="Customize your Tag"></span>
		</div>
	...
	<div class="optpoint_item" data-setno="8">
		<div class="itemhead">
	...
	<div class="optpoint_item">
		<div class="itemhead">
				<h2>Lightbox</h2>
				<span class="optpoint_hint headhint" data-hint="Lightbox Specific Settings"></span>
		</div>
	...
	<div class="optpoint_item">
		<div class="itemhead">
				<h2>Slider</h2>
				<span class="optpoint_hint headhint" data-hint="Slider Specific Settings"></span>
		</div>
		...
		<div class="itemhead" data-setno="9">
				...
				<span class="optpoint_hint headhint" data-hint="Personalize your Trigger"></span>
		</div>
	...
	<div class="optpoint_item" ng-show="[1,8].indexOf(theme.tpl) != -1">
		<div class="itemhead">
				<h2>Widget</h2>
				<span class="optpoint_hint headhint" data-hint="Widget Specific Settings"></span>
		</div>
		<optchk ng-model="theme.widget_dissoc" optlab="Disable Social Buttons" ng-show="[1,8].indexOf(theme.tpl) != -1"></optchk>
	</div>
	<div class="optpoint_item" ng-show="[1,8,9].indexOf(theme.tpl) != -1">
		<div class="itemhead">
			<h2>Addon</h2>
			<span class="optpoint_hint headhint" data-hint="Addon Specific Settings"></span>
		</div>
