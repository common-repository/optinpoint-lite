<div id="addon" class="optpoint_box">
	<div class="optpoint_item">
		...
		<div class="optpoint_group">
			<div class="paper-toggle">
				<input type="checkbox" id="addon_en" ng-model="data.addon" ng-true-value="'1'" class="optpoint_toggle">
				<label for="addon_en">Enable</label>
			</div>
			<span class="optpoint_hint" data-hint="Enable Add-on"></span>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Custom Form</label>
			<div class="optpoint_drop">
				<div class="optpoint_drop_head"><div>{{getformbyid(data.addon_form).name || (data.cforms.length?'Select Form':'No Forms')}}</div>
				<div class="bar"></div>
				</div>
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(0,data.addon_form)" ng-show="data.addon_form">Edit Form</button>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Theme</label>
			<div class="optpoint_drop">
				<div class="optpoint_drop_head"><div>{{gettheme(data.addon_theme).name || (data.themes.length?'Select Theme':'No Themes')}}</div>
				<div class="bar"></div>
				</div>
				<div class="optpoint_drop_body">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(1,data.addon_theme)" ng-show="data.addon_theme">Edit Theme</button>
		</div>
	</div>
	<div class="optpoint_item">
		<div class="itemhead">
		...
		<div class="optpoint_group">
			<div class="paper-toggle">
				<input type="checkbox" id="topbar_en" ng-model="data.topbar" ng-true-value="'1'" class="optpoint_toggle">
				<label for="topbar_en">Enable</label>
			</div>
			<span class="optpoint_hint" data-hint="Enable Topbar"></span>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Custom Form</label>
			<div class="optpoint_drop">
				<div class="optpoint_drop_head"><div>{{getformbyid(data.topbar_form).name || (data.cforms.length?'Select Form':'No Forms')}}</div>
				<div class="bar"></div>
				</div>
				<div class="optpoint_drop_body">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(0,data.topbar_form)" ng-show="data.topbar_form">Edit Form</button>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Theme</label>
			<div class="optpoint_drop">
				<div class="optpoint_drop_head"><div>{{gettheme(data.topbar_theme).name || (data.themes.length?'Select Theme':'No Themes')}}</div>
				<div class="bar"></div>
				</div>
				<div class="optpoint_drop_body">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(1,data.topbar_theme)" ng-show="data.topbar_theme">Edit Theme</button>
		</div>
	</div>
	<div class="optpoint_item">
		<div class="itemhead">
		...
		<div class="optpoint_group">
			<div class="paper-toggle">
				<input type="checkbox" id="flipbox_en" ng-model="data.flipbox" ng-true-value="'1'" class="optpoint_toggle">
				<label for="flipbox_en">Enable</label>
			</div>
			<span class="optpoint_hint" data-hint="Enable Flipbox"></span>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Custom Form</label>
			<div class="optpoint_drop">
				<div class="optpoint_drop_head"><div>{{getformbyid(data.flipbox_form).name || (data.cforms.length?'Select Form':'No Forms')}}</div>
				<div class="bar"></div>
				</div>
				<div class="optpoint_drop_body">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(0,data.flipbox_form)" ng-show="data.flipbox_form">Edit Form</button>
		</div>
		<div class="optpoint_group optpoint_dropc">
			<label>Theme</label>
			<div class="optpoint_drop">
				<div class="optpoint_drop_head"><div>{{gettheme(data.flipbox_theme).name || (data.themes.length?'Select Theme':'No Themes')}}</div>
				<div class="bar"></div>
				</div>
				<div class="optpoint_drop_body">
			...
			<button class="optpoint_button orange material-design ng-binding" ng-click="foredit.run(1,data.flipbox_theme)" ng-show="data.flipbox_theme">Edit Theme</button>
		</div>
	</div>
	<div class="optpoint_item">
		<div class="itemhead">
			<h2>Filter by Device</h2>
			<span class="optpoint_hint headhint" data-hint="Show Subscription box(Topbar&Flipbox excluded since only for Desktop) form if the user visits from"></span>
		</div>
	...
	<div class="optpoint_item">
		<div class="itemhead">
			<h2>Behaviour</h2>
			<span class="optpoint_hint headhint" data-hint="Behaviour of the Subscribe Box"></span>
		</div>
		<div class="optpoint_group optpoint_cb">
		...
		<div class="optpoint_group optpoint_cb">
			...
			<span class="optpoint_hint" data-hint="Enable Short Code"></span>
			<div class="p3">use - [optinpoint]</div>
		</div>
