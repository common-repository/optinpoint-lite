...
#optinpoint .lite_check .cbox.checked {
...
<div class="optinpoint-overlay-bg overcss">
<div class="optpoint-live-sc" ng-click="prev.goto(8)" data-lhint="Go to Additional Theme Options" style="margin:25px;">7</div>
	...
	<div class="optpoint-live-sc" ng-click="prev.goto(7)" data-lhint="Go to Additional Theme Options" style="margin:15px;bottom:0;">6</div>
		<div class="optinpoint-wrapper">
			<div id="optinpoint-newsletterform">
	    		...
	    		<div><div class="optpoint-live-sc righthov" ng-click="prev.goto(2)" data-lhint="Go to Text Box Settings" style="right: 10%;">2</div>
	    		...
	    		<div><div class="optpoint-live-sc" ng-click="prev.goto(3)" data-lhint="Go to Checkbox Settings">3</div>
	   			...
	   			<div><div class="optpoint-live-sc righthov" ng-click="prev.goto(4)" data-lhint="Go to Button Settings" style="right: 10%;">4</div>
	    		...
	    		<div>
	    			<div class="optpoint-live-sc" ng-click="prev.goto(5)" data-lhint="Go to Spinner Settings" style="right: 10%;">5</div>
        			<div class="optinpoint-signal" ng-bind-html="getSpin('1','optinpoint-wrapper',theme.spinner_c||'#fff')"></div>
        		</div>
    			</div>
			</div>
		</div>
