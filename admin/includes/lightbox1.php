...
<div class="optinpoint-overlay-bg optinpoint-wrapper" id="lightbox1">
	<div id="optinpoint-main" ng-class="{'lsoconly':theme.lite_dislogo,'limgonly':theme.lite_dissoc,'woleft':theme.lite_dislogo&&theme.lite_dissoc}">
        <div class="optpoint-live-sc" ng-click="prev.goto(8)" data-lhint="Go to Additional Theme Options" style="margin:25px;bottom:0">7</div>
		...
		<div id="optinpoint-newsletterform">
          ...
          <div>
          	...
          	<div class="lite_spinner" ng-bind-html="getSpin('7','optinpoint-wrapper',theme.spinner_c||'#000')"></div>
          </div>
