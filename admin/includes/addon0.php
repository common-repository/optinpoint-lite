...
<div class="optpoint-live-sc" ng-click="prev.goto(8)" data-lhint="Go to Additional Theme Options" style="margin:-30px">7</div>
  ...
  <div><div class="optpoint-live-sc righthov" ng-click="prev.goto(2)" data-lhint="Go to Text Box Settings" style="right:0;">2</div>
	...
	<div><div class="optpoint-live-sc" ng-click="prev.goto(3)" data-lhint="Go to Checkbox Settings" style="right:0;">5</div>
 ...
 <div style="clear:both"></div>
    <div>
    <div class="optpoint-live-sc" ng-click="prev.goto(5)" data-lhint="Go to Spinner Settings" style="left:30px;">6</div>
    <div class="optinpoint-signal" ng-bind-html="getSpin('1','optinpointb',theme.spinner_c||'#000')"></div>
  </div>
</div>