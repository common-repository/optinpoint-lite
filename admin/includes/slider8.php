...
.optinpoints .optinpoint_formbox{
margin: 0 auto;
width: calc(100% - 50px);
}
...
#optinpoints .optinpoint-socialc{
overflow: hidden;
}
...
#optinpoints .optinpoints-inner.wosoc .optinpoint-social {
display: none;
}
#optinpoints .optinpoints-inner.woleft{
padding-top: 40px;
...
<div class="optinpoints-inner" ng-class="{'wosoc':theme.slider_dissoc}">
  <div class="optpoint-live-sc" ng-click="prev.goto(8)" data-lhint="Go to Additional Theme Options" style="margin:-15px">8</div>
        ...
        <div class="optinpoints">
            ...
            <div><div class="optpoint-live-sc righthov" ng-click="prev.goto(2)" data-lhint="Go to Text Box Settings" style="right: -20px;  top: 38px;">2</div>
            ...
            <div><div class="optpoint-live-sc righthov righthov" ng-click="prev.goto(4)" data-lhint="Go to Button Settings" style="right: -20px;">4</div>
              <div class="slider_button">{{theme.button}}</div>
               <div>
	              ...
	              <div class="slider_spinner" ng-bind-html="getSpin('3','optinpoints',theme.spinner_c||'#000')"></div>
	            </div>
            </div>
