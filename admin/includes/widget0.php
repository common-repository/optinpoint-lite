...
#optinpointw .optinpoint-subs-button{
  margin: 12px 0;
  width: 100%;
text-align: center;
    background: #62bc33;
...
#optinpointw .optinpoint-subs-button:hover{
    background:#8BD331;
...
<div id="optinpointw" class="optinpointw">
<div class="optpoint-live-sc" ng-click="prev.goto(8)" data-lhint="Go to Additional Theme Options" style="top:0">7</div>
  ...
  <div><div class="optpoint-live-sc righthov" ng-click="prev.goto(4)" data-lhint="Go to Button Settings" style="left:30px;">3</div>
    <div class="optinpoint-subs-button">{{theme.button}}</div>
  </div>
  <div><div class="optpoint-live-sc" ng-click="prev.goto(7)" data-lhint="Go to Tag Settings">4</div>
          <div class="optinpoint-tag" ng-bind-html="theme.tag||'Secure and Spam free...' | safe"></div></div>
  <div><div class="optpoint-live-sc righthov" ng-click="prev.goto(3)" data-lhint="Go to Checkbox Settings" style="right:0;">5</div>
  ...
  <div>
    ...
    <div class="optinpoint-signal" ng-bind-html="getSpin('1','optinpointw',theme.spinner_c||'#fff')"></div>
  </div>
</div>